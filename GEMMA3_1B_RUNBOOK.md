...
cd Megatron-LM
# Note: Ensure you are on the verified commit 0a74daa0f or later
bash sanity_check.sh
```

## 2. Execute Pipeline
Run the following command to trigger the automated flow. You must provide a HuggingFace token with access to the Gemma3 repository.
