...
python /home/jovyan/Megatron-Bridge-Surya/examples/conversion/hf_megatron_roundtrip.py     --hf-model-id $HF_MODEL_PATH     --output-dir $ROUNDTRIP_PATH     --trust-remote-code
