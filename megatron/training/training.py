...
def training_log(
    ...
    # Preserve the first-iteration accumulation window only for a fresh run. On resume,
    # reset after the forced first log so that loss is not counted again at the next log.
